...
public class StatisticCollectorTest {
    ...
    public void testSolution1() {
        List<Pair<Integer, Long>> expected = Arrays.asList(new Pair<>(1,1L), new Pair<>(2,1L), new Pair<>(3,1L));
    ...
    public void testSolution3() {
        List<Pair<Integer, Long>> expected = Arrays.asList(new Pair<>(3,1L), new Pair<>(1,2L), new Pair<>(2,2L));
        Assert.assertEquals(statisticCollector.getStatistic(Arrays.asList(2, 2, 1, 1, 3)), expected);
    }

    @Test
    public void testSolution4() {
        List<Pair<Integer, Long>> expected = Arrays.asList(new Pair<>(1,1L), new Pair<>(3,3L));
